...
fact :: Int32 -> R Int32
fact 0 = return 1
fact n = fmap H.fromSEXP [r| as.integer(n_hs * fact_hs(as.integer(n_hs -1))) |]

factSexp :: SEXP (R.Vector Int32) -> R (SEXP (R.Vector Int32))
factSexp (fromSEXP -> 0 :: Int32) = return $ mkSEXP (1::Int32)
factSexp (fromSEXP -> n :: Int32) = fmap H.fromSEXP [r| as.integer(n_hs * fact_hs(as.integer(n_hs -1))) |]
